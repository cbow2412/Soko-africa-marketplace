...
/**
 * Advanced Masonry Grid Component - Surpasses Pinterest
 * 
 * Features:
...
export default function AdvancedMasonryGrid({
  ...
  const columnItems = useMemo(() => {
    ...
    items.forEach((item) => {
      ...
      const itemHeight = 300 / aspectRatio; // Base width 300px
              ...
              >
                ...
                {!isVisible && (
                  <motion.div
                    ...
                    className="w-full h-64 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 rounded-2xl"
                  />
                )}
